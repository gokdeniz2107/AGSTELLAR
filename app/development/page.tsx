          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden md:flex items-center space-x-6">
                ...
                <Link href="/development" className="text-green-400 hover:text-green-300 text-sm font-medium">
                  Development
                </Link>
        ...
        <main className="py-12">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h1 className="text-5xl font-black tracking-tight mb-4">Development</h1>
              <div className="max-w-4xl mx-auto">
                <h2 className="text-2xl font-bold mb-4">Code with Purpose. Build with Vision.</h2>
                ...
                <p className="text-zinc-300 text-lg leading-relaxed mb-4">
                  ...
                  technologies, and performance-first architectures with clear business goals. From high-performance
                  APIs and full-stack platforms to enterprise systems and custom applications, every line we build is
                  intentional.
                </p>
                <p className="text-zinc-300 text-lg leading-relaxed mb-4">
                ...
                <p className="text-zinc-400 text-lg">
                  Each project is an opportunity to combine cutting-edge technology with thoughtful design — delivering
                  not just functional systems, but scalable value.
                </p>
              </div>
            </div>
