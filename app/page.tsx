          ...
          <section className="py-8">
            <div className="container mx-auto px-4">
              <div className="grid md:grid-cols-12 gap-8">
                {/* Left Sidebar - The Verge style vertical text */}
                <div className="hidden md:block md:col-span-1">
                  <div className="sticky top-24 transform -rotate-90 origin-top-left translate-y-32 translate-x-6">
                    <h2 className="text-5xl font-black tracking-tighter text-white uppercase">Featured</h2>
                  </div>
                </div>
                ...
                {[1, 2, 3].map((item) => (
                  <div key={item} className="group">
                    <div className="relative aspect-video mb-4 overflow-hidden">
                      <Image
                        src={`/placeholder.svg?height=300&width=500&query=tech%20article%20${item}`}
                        alt={`Latest article ${item}`}
                        fill
                        className="object-cover group-hover:scale-105 transition-transform duration-300"
                      />
                    </div>
                    <Badge className="bg-zinc-800 text-xs mb-2">Technology</Badge>
                    <h3 className="text-xl font-bold mb-2 group-hover:text-cyan-400">
                      <Link href="#">The Future of Software Development in the AI Era</Link>
                    </h3>
                    <p className="text-zinc-400 text-sm mb-3">
                      How artificial intelligence is changing the way we build and deploy software applications.
                    </p>
                    <div className="flex items-center text-xs text-zinc-500">
